...
//             const sortedBusinesses = sortBusinesses(newBusinesses, sortBy);
...
//         switch (sortBy) {
//             case 'rating':
//                 return sortedBusinesses.sort((a, b) => b.averageRating - a.averageRating);
//             case 'price':
//                 return sortedBusinesses.sort((a, b) => a.price - b.price);
//             case 'Alphabetical':
//                 return sortedBusinesses.sort((a, b) => a.localeCompare(b));
//             default:
